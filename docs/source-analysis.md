...
기존 특전 미해석 기록은 이전 조사 시점의 결과다. 두 파일의 wrapper를 해독했고, KO/JP 헤더 대조와 한국어 52개 시나리오 전수 검증으로 갱신했다. 신분 5/8/9와 정책 구성 참조도 정정했다. 현재 근거는 [DLC·도감 분석](dlc-and-catalog-analysis.md)과 최신 완료 보고서를 따른다. 기존 원천·보고서는 덮어쓰지 않았다.
